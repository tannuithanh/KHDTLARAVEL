...
<div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <h4 class="mb-sm-0" style="font-size:20px"><a href="{{ route('listCarBrands', $car_brands_id) }}" type="button"
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="font-size:20px">Thương hiệu xe: <span
                        style="color: red">{{ $CarBrands->name }} ({{ $CarBrandsChild->name }})</span></h4>
                        <a href="{{ route('creatProject.get', ['id' => $CarBrands->id, 'car_brands_child_id' => $CarBrandsChild->id]) }}" class="btn btn-danger btn-rounded waves-effect waves-light">
                                ...
                                @foreach ($project as $value)
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            @if ($value->completion == 100 && $value->status == 0)
