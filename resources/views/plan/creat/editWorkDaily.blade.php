...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0">CHỈNH SỬA KẾ HOẠCH NGÀY</h4> 
    </div>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
                        ...
                        <div style="border-bottom: 3px solid gray!important;">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$workDaily->categoryDaily}}" class="form-control" id="validationCustom03" placeholder="hạng mục công việc" name="categoryDaily" required="">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="1" cols="" type="text" class="form-control" id="validationCustom04" placeholder="Chi tiết công việc"  required="" name="describeDaily">{{$workDaily->describeDaily}}</textarea>
                                        <div class="invalid-feedback">
                                            Vui lòng nhập dữ liệu.
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input value="{{$workDaily->date}}" type="date" class="form-control" id="validationCustom05" placeholder="" required="" name="date">
                                        <div class="invalid-feedback">
                                            Vui lòng nhập dữ liệu.
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input value="{{$workDaily->note}}" type="text" class="form-control" id="validationCustom04" placeholder=""  name="note">
                                        <div class="invalid-feedback">
                                            Vui lòng nhập dữ liệu.
                                        </div>
                                    </div>
