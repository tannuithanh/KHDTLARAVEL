...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    <h4 class="mb-sm-0">TẠO CÔNG VIỆC DÀI HẠN</h4>
</div>
        ...
        <div class="card-body">
            <form class="custom-validation" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" style="font-size: 18px" class="form-control" name="categoryMonth"
                        required="" placeholder="Tên công việc">
                </div>
                <div class="mb-3">
                    <label class="form-label">Mô tả công việc</label>
                    <textarea id="myTextarea" style="font-size: 18px" type="text" class="form-control" name="describeMonth" required="" placeholder="Mô tả công việc" rows="5"></textarea>
                ...
                <div class="mb-3 col-lg-2">
                    <input class="form-control" type="date" name="startMonth"  id="start-date">
                </div>
                <label for="end-date" required multiple="multiple" class="col-md-2 col-form-label">Ngày kết thúc</label>
                <div class="mb-3 col-lg-2">
                    <input class="form-control" type="date"  name="endMonth" id="end-date">
                </div>
                <div class="mb-3 ">
