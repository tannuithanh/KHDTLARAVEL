...
class TacVu extends Controller
{
    ...
    public function getAllWorks($id) {
        $projectDepartment = ProjectDepartment::find($id);
            
        if ($projectDepartment) {
            $projectId = $projectDepartment->project_id;
        ...
        // If no ProjectDepartment or project is found, return a 404 response
    ...
    public function saveTacVu(Request $request) {
        ...
        return response()->json(['message' => 'Các liên kết công việc đã được lưu thành công']);
    }
